...
export const movePage = async (req: Request, res: Response) => {
  try {
    ...
    const newPath = await fileSystemService.movePage(oldPath, newFolderPath || '');
...
export const getPages = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to get pages', message: (error as Error).message });
  }
};
...
export const getPage = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to get page', message: (error as Error).message });
  }
};
...
export const createPage = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to create page', message: (error as Error).message });
  }
};
...
export const updatePage = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to update page', message: (error as Error).message });
  }
};
...
export const deletePage = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to delete page', message: (error as Error).message });
  }
};
